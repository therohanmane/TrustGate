...
const BTN   = { width:'100%', background:'linear-gradient(135deg,var(--gold),var(--gold2))', color:'var(--ink)', fontFamily:"'Syne',sans-serif", fontWeight:700, fontSize:15, padding:16, borderRadius:10, border:'none', cursor:'pointer', marginTop:8, letterSpacing:'0.01em', transition:'all 0.2s', minHeight:52 };

const FEATS = [['🔐','End-to-end AES-256 encrypted'],['👁️','Zero-knowledge architecture'],['⚡','Instant secure access'],['🛡️','Multi-factor protection']];
...
export default function Login() {
  ...
  return (
    <div className="auth-wrap">
      {/* LEFT PANEL — hidden on mobile, visible tablet+ */}
      <div className="auth-left">
        ...
        <h2 style={{ fontSize:'clamp(28px,3vw,46px)', fontWeight:800, color:'var(--cream)', lineHeight:1.1, letterSpacing:-1, marginBottom:20, position:'relative' }}>
          Access your<br/>
          <span style={{ background:'linear-gradient(135deg,var(--gold),var(--gold3))', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>secure vault</span>
        </h2>
        <p style={{ fontSize:15, color:'var(--slate2)', lineHeight:1.7, marginBottom:40, fontWeight:300, position:'relative' }}>
      ...
      <div className="auth-right">
        <div className="auth-box">
          {/* Mobile logo */}
          <div style={{ fontFamily:"'Syne',sans-serif", fontSize:22, fontWeight:800, color:'var(--gold2)', marginBottom:28, display:'none' }} className="auth-mobile-logo">
            Trust<span style={{ color:'var(--cream)', opacity:0.5 }}>Gate</span>
          </div>

          <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:8 }}>
            <h2 style={{ fontFamily:"'Syne',sans-serif", fontSize:'clamp(24px,3vw,30px)', fontWeight:800, color:'var(--cream)', letterSpacing:'-0.5px' }}>Welcome back</h2>
            <span style={{ fontSize:13, color:'var(--slate)', cursor:'pointer', minHeight:44, display:'flex', alignItems:'center' }} onClick={() => nav('/')}>← Back</span>
          </div>
          <p style={{ fontSize:14, color:'var(--slate2)', marginBottom:32 }}>Sign in to access your digital legacy vault</p>
          ...
          <div style={{ textAlign:'right', marginBottom:20 }}>
            <span style={{ fontSize:12, color:'var(--slate2)', cursor:'pointer', minHeight:44, display:'inline-flex', alignItems:'center' }} onClick={() => nav('/forgot-password')}>
              Forgot password?
            </span>
          </div>
          ...
          <button style={{ width:'100%', background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:10, padding:13, fontSize:14, color:'var(--cream)', fontFamily:"'DM Sans',sans-serif", cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:10, fontWeight:500, minHeight:48 }}>
